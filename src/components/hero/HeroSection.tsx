    ...
    >
      ...
      >
        <div className="flex items-center gap-2 group cursor-default">
          <motion.div className="relative" whileHover={{ filter: 'brightness(1.2)' }}>
            <div
            ...
            />
            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" className="relative sm:hidden">
              <path d="M16 4L4 28h5l7-16 7 16h5L16 4z" fill="url(#logoGradHero)" />
              <defs>
                <linearGradient id="logoGradHero" x1="4" y1="4" x2="28" y2="28">
                  <stop stopColor="#6366F1" />
                  <stop offset="1" stopColor="#22D3EE" />
                </linearGradient>
              </defs>
            </svg>
            <svg width="28" height="28" viewBox="0 0 32 32" fill="none" className="relative hidden sm:block">
              <path d="M16 4L4 28h5l7-16 7 16h5L16 4z" fill="url(#logoGradHero2)" />
              <defs>
                <linearGradient id="logoGradHero2" x1="4" y1="4" x2="28" y2="28">
                  <stop stopColor="#6366F1" />
                  <stop offset="1" stopColor="#22D3EE" />
                </linearGradient>
              </defs>
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 flex items-center min-h-auto lg:min-h-screen">
        <div className="w-full flex flex-col lg:grid lg:grid-cols-[55%_45%] gap-6 sm:gap-8 lg:gap-0 items-center lg:py-0 pt-20 pb-32 lg:pb-20">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left justify-center space-y-6 sm:space-y-8 sm:z-[10] z-10 w-full">
            ...
            {/* Badge — lives here, naturally above the headline */}
            <motion.div
          ...
          {/* RIGHT — 3D Globe column (position: relative so FloatingCards anchors here) */}
          <div className="hidden md:block relative w-full overflow-visible md:h-[400px] lg:h-[650px]">
            ...
            {/* FloatingCards scoped inside globe column */}
            <FloatingCards />
          </div>
        </div>
      </div>
